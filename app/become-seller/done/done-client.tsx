// app/become-seller/done/done-client.tsx
'use client'
...
export function BecomeSellerDoneClient({ preparingText }: { preparingText: string }) {
  ...
  return (
    <div className="min-h-screen bg-[#08080E] text-[#F0EDE6] flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500">{preparingText}</p>
      </div>
    </div>
  )
}
