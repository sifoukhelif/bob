...
export const metadata = { title: 'إعدادات استلام الأرباح' }
  ...
  return (
    <div className="min-h-screen bg-[#08080E] text-[#F0EDE6]">
      ...
      <main className="max-w-2xl mx-auto px-6 pt-28 pb-24">
        <h1 className="text-3xl font-serif font-bold mb-2">إعدادات استلام الأرباح</h1>
        <p className="text-gray-500 text-sm mb-10">
          أدخل بيانات استلام أرباحك. حالياً التحويلات تتم يدوياً من فريق المنصة بشكل دوري بناءً على هذه البيانات.
        </p>
        <PayoutSettingsForm
          initial={{
