    ...
    <div className="min-h-screen bg-[#08080E] text-[#F0EDE6] overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-36 flex flex-col items-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 flex flex-col items-center text-center relative z-10 w-full">
          ...
          <AdBanner label={t.ads.banner} className="w-full mb-6 animate-fade-up" />

          <Image src="/logo.png" alt="DEGITALE" width={120} height={120} priority
            className="mb-6 rounded-3xl shadow-[0_0_50px_rgba(201,168,76,0.3)] animate-fade-up" style={{ animationDelay: '0.05s' }} />
      ...
      <footer className="border-t border-white/5 py-16 bg-[#06060A]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-8 text-xs font-bold text-gray-500 uppercase tracking-widest">
            <Link href="/blog" className="hover:text-[#C9A84C] transition-colors whitespace-nowrap">{t.blog.badge}</Link>
            <Link href="/discover" className="hover:text-[#C9A84C] transition-colors whitespace-nowrap">{t.discover.badge}</Link>
            <Link href="/pricing" className="hover:text-[#C9A84C] transition-colors whitespace-nowrap">{t.pricing.badge}</Link>
            <Link href="/features" className="hover:text-[#C9A84C] transition-colors whitespace-nowrap">{t.features.badge}</Link>
