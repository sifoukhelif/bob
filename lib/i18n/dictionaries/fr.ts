...
export const fr = {
  ...
  discover: {
    ...
    homeLink: 'Accueil',
    topRatedTitle: '⭐ Les mieux notés', bestSellersTitle: '🔥 Meilleures ventes', newArrivalsTitle: '✨ Nouveautés',
    categoriesTitle: 'Parcourir par catégorie', featuredStoresTitle: '🏆 Boutiques en vedette',
    viewStore: 'Visiter la boutique', productsCount: 'produits',
    emptyText: "Pas assez de contenu à afficher dans cette section pour l'instant.",
  },
  pricing: {
    badge: 'Tarifs', title: 'Une tarification simple et transparente', subtitle: "Aucun frais d'abonnement, aucun frais de publication — vous ne gagnez que lorsque vous vendez.",
    homeLink: 'Accueil',
    sellerCardTitle: 'Pour les vendeurs', sellerCommission: '80%', sellerCommissionLabel: 'Vous conservez sur chaque vente',
    sellerPoint1: "Aucun frais d'abonnement mensuel", sellerPoint2: 'Aucun frais pour publier un produit', sellerPoint3: 'Seulement 20% de commission sur les ventes réelles',
    sellerPoint4: 'Soyez payé par virement bancaire, Payoneer, Visa, RedotPay ou Binance',
    buyerCardTitle: 'Pour les acheteurs', buyerFree: 'Gratuit', buyerFreeLabel: 'Parcourez et achetez sans frais supplémentaires',
    buyerPoint1: 'Le prix affiché est le prix final, sans frais cachés', buyerPoint2: 'Paiement sécurisé et chiffré',
    buyerPoint3: 'Garantie de remboursement de 14 jours', buyerPoint4: 'Lien de téléchargement instantané après achat',
    faqTitle: 'FAQ sur les tarifs',
    faq1q: 'Y a-t-il des frais cachés ?', faq1a: "Non. Le prix que vous voyez est le prix que vous payez. La commission de la plateforme est déduite uniquement de la part du vendeur, sans jamais affecter le prix de l'acheteur.",
    faq2q: 'Quand suis-je payé en tant que vendeur ?', faq2a: 'Les versements sont actuellement manuels, traités périodiquement après chaque vente selon les coordonnées de paiement que vous avez définies dans votre compte.',
    faq3q: 'Le taux de commission peut-il changer ?', faq3a: 'La commission actuelle est de 20%. Tout changement futur sera annoncé à l\'avance avant son entrée en vigueur.',
    ctaTitle: 'Prêt à commencer ?', ctaSell: 'Commencer à vendre', ctaShop: 'Parcourir la boutique',
  },
  features: {
    badge: 'Fonctionnalités', title: 'Tout ce dont vous avez besoin, au même endroit', subtitle: "Une plateforme conçue pour simplifier l'achat et la vente numériques, de bout en bout.",
    homeLink: 'Accueil',
    f1title: 'Téléchargements instantanés et sécurisés', f1text: 'Un lien de téléchargement chiffré et limité dans le temps juste après l\'achat, valable 48 heures.',
    f2title: 'Paiements sécurisés', f2text: 'Transactions entièrement chiffrées — vos données financières ne sont jamais stockées sur nos serveurs.',
    f3title: 'Avis vérifiés', f3text: "Uniquement de vrais avis de la part d'acheteurs ayant réellement effectué un achat.",
    f4title: 'Liste de souhaits', f4text: 'Enregistrez les produits que vous aimez et retrouvez-les à tout moment.',
    f5title: 'Trois langues', f5text: 'Le site entier est disponible en arabe, anglais et français.',
    f6title: 'Méthodes de paiement multiples', f6text: 'Virement bancaire, Payoneer, Visa, RedotPay ou Binance — choisissez ce qui vous convient.',
    f7title: 'Garantie de remboursement', f7text: "14 jours pour demander un remboursement complet si un produit ne correspond pas à sa description.",
    f8title: 'Notifications instantanées', f8text: 'Alertes dans l\'application et par email pour chaque vente ou mise à jour de votre commande.',
    f9title: 'Tableau de bord complet', f9text: 'Suivez vos ventes, vos revenus et les commandes des acheteurs en un seul endroit.',
    ctaTitle: 'Essayez la plateforme maintenant', ctaSell: 'Commencer à vendre', ctaShop: 'Parcourir la boutique',
  },
  faq: {
    badge: 'FAQ',
  ...
  messages: {
    title: 'Messages',
    navLabel: 'Messages',
    emptyConversations: 'Aucune conversation pour le moment',
    ...
    startConversationError: "Impossible de démarrer la conversation, veuillez réessayer",
    cannotMessageSelf: "Vous ne pouvez pas vous envoyer un message à vous-même",
  },
  wishlist: {
    navLabel: 'Favoris',
