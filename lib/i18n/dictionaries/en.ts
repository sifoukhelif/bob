...
export const en = {
  ...
  product: { login: 'Log In', notFoundTitle: 'Product not found', freeLabel: 'Free', save: 'Save', sales: 'sales', reviews: 'reviews', deliveryPrefix: 'Delivery within', deliveryUnit: 'days', shareWhatsapp: 'Share on WhatsApp', shareMessage: 'Check out this product on DEGITALE' },
  ...
  account: {
    ...
    avatar: {
      ...
      changeButton: 'Change Picture', uploading: 'Uploading…',
      saved: '✅ Profile picture updated',
      errorUpload: 'Could not upload the image, please try again',
      errorType: 'The file must be an image (JPG or PNG)',
      errorSize: 'Image size must not exceed 2MB',
    },
    password: {
      sectionTitle: 'Password',
      currentLabel: 'Current password', newLabel: 'New password', confirmLabel: 'Confirm new password',
      saveButton: 'Update Password', savingText: 'Updating…',
    ...
    email: {
      ...
      currentLabel: 'Current email', newLabel: 'New email address',
      saveButton: 'Update Email', savingText: 'Sending…',
      successMessage: '✅ We sent a confirmation link to both your old and new email. Click the link to complete the change.',
      errorGeneric: 'Could not update the email, please try again',
      errorSameEmail: 'This is already your current email',
    },
    dangerZone: {
      title: 'Danger Zone',
      text: 'Deleting your account permanently removes your personal data. To request account deletion, contact our support team.',
  ...
  pricing: {
    ...
    homeLink: 'Home',
    sellerCardTitle: 'For Sellers', sellerCommission: '80%', sellerCommissionLabel: 'You keep from every sale',
    sellerPoint1: 'No monthly subscription fees', sellerPoint2: 'No fee to list a product', sellerPoint3: 'Only 20% platform commission on actual sales',
    sellerPoint4: 'Get paid via bank transfer, Payoneer, Visa, RedotPay, or Binance',
    buyerCardTitle: 'For Buyers', buyerFree: 'Free', buyerFreeLabel: 'Browse and buy with no extra fees',
    buyerPoint1: 'The listed price is the final price, no hidden fees', buyerPoint2: 'Secure, encrypted payment',
    buyerPoint3: '14-day refund guarantee', buyerPoint4: 'Instant download link after purchase',
    faqTitle: 'Pricing FAQ',
    faq1q: 'Are there any hidden fees?', faq1a: "No. The price you see is the price you pay. The platform commission is deducted from the seller's share only, never affecting the buyer's price.",
    faq2q: 'When do I get paid as a seller?', faq2a: 'Payouts are currently manual, processed periodically after each sale based on the payout details you set in your account.',
    faq3q: 'Can the commission rate change?', faq3a: 'The current commission is 20%. Any future change will be announced in advance before it takes effect.',
    ctaTitle: 'Ready to start?', ctaSell: 'Start Selling', ctaShop: 'Browse the Shop',
  },
  features: {
    badge: 'Features', title: 'Everything You Need, in One Place', subtitle: 'A platform built to make digital buying and selling effortless, end to end.',
    homeLink: 'Home',
    f1title: 'Instant, Secure Downloads', f1text: 'An encrypted, time-limited download link right after purchase, valid for 48 hours.',
    f2title: 'Secure Payments', f2text: 'Fully encrypted transactions — your financial data is never stored on our servers.',
    f3title: 'Verified Reviews', f3text: 'Only real reviews from buyers who actually completed a purchase.',
    f4title: 'Wishlist', f4text: 'Save products you like and come back to them anytime.',
    f5title: 'Three Languages', f5text: 'The whole site is available in Arabic, English, and French.',
    f6title: 'Multiple Payout Methods', f6text: 'Bank transfer, Payoneer, Visa, RedotPay, or Binance — pick what suits you.',
    f7title: 'Refund Guarantee', f7text: '14 days to request a full refund if a product isn\'t as described.',
    f8title: 'Instant Notifications', f8text: 'In-app and email alerts for every sale or update on your order.',
    f9title: 'Full Dashboard', f9text: 'Track your sales, earnings, and buyer orders all in one place.',
    ctaTitle: 'Try the platform now', ctaSell: 'Start Selling', ctaShop: 'Browse the Shop',
  },
  faq: {
    badge: 'FAQ',
  ...
  notifications: {
    title: 'Notifications', markAllRead: 'Mark all as read', emptyText: 'No notifications yet',
    orderConfirmedTitle: 'Your order is confirmed', saleTitle: 'New sale 🎉', newListingTitle: 'New product pending review',
  ...
  messages: {
    ...
    startConversationError: 'Could not start the conversation, try again',
